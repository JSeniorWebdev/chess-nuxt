  ...
  <div class="tests-result">
    <div class="tests-result__top">
      <div class="tests-result__guidance">
        <div
          ...
          @click="$router.push('/tests/series')"
        >
          <img src="~/assets/icons/left-arrow-white.svg" />
          <div class="tests-result__guidance__text">Tests</div>
        </div>
      </div>
    </div>
    <div class="tests-result__content">
      <div class="tests-result__description">
        <div class="tests-result__description__text">
          <div class="tests-result__description__title">Test complete!</div>
      ...
      <div class="tests-result__compare">
        <div class="tests-result__title">Compare results</div>
        <div
    ...
    <div class="tests-result__review">
      <div class="tests-result__review__title">
        <div class="tests-result__title">Review answers</div>
      </div>
      <ResultTab />
    </div>
  </div>
...
export default {
  ...
  methods: {
    transformDate(dateTimeString) {
      console.log("dateTimeString", dateTimeString, typeof dateTimeString);
      if (!dateTimeString) {
        return "-";
      }

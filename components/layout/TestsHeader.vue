  ...
  >
    <div class="tests-header__container" :class="$route.name">
      ...
      <ul class="tests-header__nav">
        ...
        <li class="tests-header__nav__item tests-header__icon desktop">
          <img src="~/assets/icons/diamond.svg" />
          <div class="tests-header__icon__label">14</div>
        </li>
        <li
          class="
            tests-header__nav_item tests-header__icon tests-header__coin-icon
            desktop
          "
        >
          <img src="~/assets/icons/coin.svg" />
          <div class="tests-header__icon__label">23</div>
        </li>
      </ul>
      <div
        v-if="$route.name.includes('-board')"
        class="tests-header__board mobile"
        :class="$route.name"
      >
